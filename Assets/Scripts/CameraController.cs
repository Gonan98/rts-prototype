...
public class CameraController : MonoBehaviour
{
    ...
    private Camera _cam;
    private HashSet<MarineBehaviour> _selectedUnits { get; } = new HashSet<MarineBehaviour>();
    ...
    private void StartClick()
    {
        ...
        foreach (MarineBehaviour unit in _selectedUnits)
        {
            unit.DeSelect();
        }
    ...
    private void ReleaseClick()
    {
        ...
        foreach (MarineBehaviour unit in PlayerUnitManager.Instance.Units)
        {
        ...
        {
            if (_hit.collider.TryGetComponent(out MarineBehaviour _unit))
            {
                if (PlayerUnitManager.Instance.Units.Contains(_unit))
                {
